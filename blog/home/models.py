...
class Article(models.Model):
    ...
    # 参数 on_delete user表信息删除，文章信息也同步删除
    ...
    class Meta:
        ...
        ordering = ('-created',)
        db_table='tb_article'
        verbose_name='文章管理' #admin展示的名字
        verbose_name_plural=verbose_name  #admin展示的名字复数
    # 函数 __str__ 定义当调用对象的 str() 方法时的返回值内容，__方法__  模仿方法，自动调用
...
class Comment(models.Model):
    #评论内容
    content=models.TextField()
    #评论的文章，SET_NULL 删除关联数据，与之关联的数据为null
